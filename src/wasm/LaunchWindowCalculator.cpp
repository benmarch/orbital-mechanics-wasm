...
void LaunchWindowCalculator::calculateOnlyOpportunity() {
    ...
    m_onlyOpportunity.lwst = m_orbit.getElements().Om + M_PI;
...
void LaunchWindowCalculator::calculateAscendingNodeOpportunity()
{
    ...
    m_ascendingNodeOpportunity.lwst = m_orbit.getElements().Om + m_ascendingNodeOpportunity.delta;
...
void LaunchWindowCalculator::calculateDescendingNodeOpportunity()
{
    ...
    m_descendingNodeOpportunity.lwst = m_orbit.getElements().Om + (M_PI - m_descendingNodeOpportunity.delta);
